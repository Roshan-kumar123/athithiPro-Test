...
const AgencyDropdown = ({
  ...
  const allAvailableSelected =
    ...
    availableAgents.every((agent) => isAgentSelected(agent));
      ...
      {isOpen && (
        <div className="agency-dropdown-menu">
          <div className="agency-dropdown-header">
            ...
            {/* Only show Select All/Deselect All when there are assigned agents */}
            {assignedAgents.length > 0 && availableAgents.length > 0 && (
              <div className="agency-select-controls">
                <button
                  className={`select-all-btn ${
                    allAvailableSelected ? "active" : ""
                  }`}
                  onClick={
              ...
              filteredAgents.map((agent) => {
                ...
                return (
                  <div
                    ...
                    onClick={() => !isAssigned && handleAgentToggle(agent)}
                  >
          ...
          <div className="agency-dropdown-footer">
            ...
            <div className="agency-actions">
              {/* Always show Add and Clear buttons */}
              <button
                className="add-btn"
                onClick={handleAdd}
              ...
              {/* Show Clear All only when there are assigned agents */}
              {assignedAgents.length > 0 && (
                <button
                  className="clear-all-btn"
                  onClick={handleClearAll}
                  title="Remove all assigned agents"
                >
